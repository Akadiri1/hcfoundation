...
// }
  ...
  // Legacy PEAR Mail block removed: dead code from an unrelated project,
  // and it carried a hardcoded webmail credential. Mail goes through
  // PHPMailer (v1/phpm) using the settings held in the admin panel.

...
$bd = previewBody($section1[0]['input_text'], 50);
...
<meta property="og:description" content="'.$section1[0]['input_text'].'" />';
echo '<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="'.$tn.'">
<meta name="twitter:description" content="'.$section1[0]['input_text'].'">
